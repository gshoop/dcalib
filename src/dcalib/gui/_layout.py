"""Window sizing policy and settings helpers for the dcalib GUI.
...
tab plots only ~170 px tall once the System Map takes its share.

Persistence: ``QSettings`` in Ini format under the user scope
(``~/.config/dcalib/dcalib-gui.ini`` on Linux). The window geometry and dock
